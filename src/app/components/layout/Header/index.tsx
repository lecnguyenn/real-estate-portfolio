        ...
        <div className="absolute w-full z-[777] top-0 left-0">
            ...
            <header className="flex w-full z-2 py-3.5 px-44 border-b border-[hsla(0,0%,100%,.15)]">
                ...
                <ul className="flex items-center list-none m-0 p-0 my-0 mx-auto uppercase text-white text-[13px]">
                    <li>
                        <Link href="/" className="py-[15px] px-5 font-semibold">Home</Link>
                    </li>
                    <li>
                        <Link href="/" className="py-[15px] px-5 font-semibold">Contact us</Link>
                    </li>
                    <li>
                        <Link href="/" className="py-[15px] px-5 font-semibold">Property</Link>
                    </li>
                    <li>
                        <Link href="/" className="py-[15px] px-5 font-semibold">For rent</Link>
                    </li>
                    <li>
                        <Link href="/" className="py-[15px] px-5 font-semibold">For Sale</Link>
                    </li>
                </ul>
                {/* </div> */}
            </header>
