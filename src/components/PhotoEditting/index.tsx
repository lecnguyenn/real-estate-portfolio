    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-[#16191e] text-center">
            <div>
                ...
                <ImageComparisonSlider bgImageSource="/images/editting/brightness-2.jpg" aboveImageSource="/images/editting/brightness-1.jpg" />
            </div>
            <div>
            ...
            <div>
                ...
                <ImageComparisonSlider bgImageSource="/images/editting/lens-1.jpg" aboveImageSource="/images/editting/lens-2.jpg" />
            </div>
            <div>
                <h5 className="my-6 font-semibold">Lens Spot Removal</h5>
                <ImageComparisonSlider bgImageSource="/images/editting/lens-spot-2.jpg" aboveImageSource="/images/editting/lens-spot-1.jpg" />
            </div>
            <div>
