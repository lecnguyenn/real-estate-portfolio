      ...
      <div className="container mx-auto">
        ...
        <div className="max-w-7xl mx-auto p-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <ImageComparisonSlider bgImageSource="/images/compare3.jpg" aboveImageSource="/images/compare2.jpg" />
            <ImageComparisonSlider bgImageSource="/images/compare5.jpg" aboveImageSource="/images/compare4.jpg" />
